...
O workspace usa `resolver = "3"`, compatível com Edition 2024. A entrada do kernel mantém somente a sequência de alto nível; detalhes concretos ficam em funções de inicialização pequenas até que um módulo separado tenha um consumidor real.

...
- **Safe Rust by default.** `unsafe` is restricted to boundaries where hardware, privileged CPU state, boot integration, raw stack/register manipulation, or invariants not expressible in the type system require it.
...
- [Input](docs/input.md)
- [Task and execution model](docs/tasks.md)
